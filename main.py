...
def chatbot(user_input, memory):
    ...
    if "hi" in user_input or "hello" in user_input:
        return "Hi there! I'm Nexa here to assist you. What's your name?"
...
print("Nexa: Hi, I'm Nexa ! I'm a simple chatbot, I'm here to assist you!")
...
while True:
    ...
    if user_input.lower() == 'bye':
        print(f"Nexa: Goodbye, {memory.get('name', 'friend')}! Have a great day!")
        break  
